...
const Button = ({ name }: IButton) => {
  return (
    <div className="flex justify-center items-center mb-3">
      <button className="group relative z-10 h-10 w-full overflow-hidden bg-white text-xl text-black  font-bold border-secondary border-2">
        ...
        <span className="absolute -inset-16 origin-left rotate-12 scale-x-0 transform bg-sky-700 transition-transform duration-500 group-hover:scale-x-100 group-hover:duration-700"></span>
