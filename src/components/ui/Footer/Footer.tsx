import "./footer.css";
import waveImage from '../../../assets/footerWaves.png';
const Footer = () => {
  return (
    <>
    <div>
          ...
          <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
              ...
              <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
                ...
                <div>
                  <strong className="font-medium text-black"> About </strong>
            ...
            <div className="mt-16 border-t border-gray-100 pt-8">
              <p className="text-center text-xs/relaxed text-gray-900">
                © Company 2022. All rights reserved.
                <br />
                Created with
                <a
                  href="#"
                  className="text-gray-900 underline transition hover:text-gray-900/75"
                >
                  Laravel
                </a>
                and
